  ...
  return (
    <div>
      ...
      {!showCart ? (
                ...
                {category.plants.map((plant, plantIndex) => (
                  ...
                  <div className="product-card" key={plantIndex}>
                    ...
                    <button
                      ...
                      disabled={addedToCart[plant.name]} // ✅ disable button
                    >
        ...
        <CartItem onContinueShopping={handleContinueShopping} onItemRemoved={handleItemRemoved} // ✅ Pass callback to CartItem
        />
      )}
    </div>
  );
